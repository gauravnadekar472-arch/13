...
- If user says "aur detail me batao", continue the same topic.
- If conversation context exists, ALWAYS use it.
- You ARE allowed to generate images when asked.
- Do NOT say you cannot generate images.
- If user provides file text, answer ONLY based on that file.
`;
...
app.post("/api/chat", async (req, res) => {
  try {
    ...
    // Add user + assistant previous history
